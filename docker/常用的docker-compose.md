...
services:
  master:
    ...
    restart: always
    command: redis-server /usr/local/etc/redis/redis.conf --port 6379 --requirepass antsdouble  --appendonly yes 
    ports:
      - 6379:6379
    volumes:
  ...
  slave1:
    ...
    restart: always
    command: redis-server /usr/local/etc/redis/redis.conf --slaveof 10.194.67.168 6379 --port 6380  --requirepass antsdouble --masterauth antsdouble  --appendonly yes
    ports:
      - 6380:6380
    volumes:
  ...
  slave2:
    ...
    restart: always
    command: redis-server /usr/local/etc/redis/redis.conf --slaveof 10.194.67.168 6379 --port 6381  --requirepass antsdouble --masterauth antsdouble  --appendonly yes
    ports:
      - 6381:6381
    volumes:
